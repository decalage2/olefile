===============================
olefile |version| documentation
===============================

This is the home page of the documentation for olefile. The latest
version can be found
`online <http://olefile.readthedocs.io/en/latest/>`__, otherwise
...
`Repository <https://github.com/decalage2/olefile>`__ -
`Updates on Twitter <https://twitter.com/decalage2>`__
